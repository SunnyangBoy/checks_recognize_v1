    ...
    #with open(create_label, 'w') as lb:
        for root, dirs, files in os.walk(trainImgPath):  # trainLabelPath):
            for file in sorted(files):
                ...
                ####
                #img_savepath = os.path.join('/home/chen-ubuntu/Desktop/checks_dataset/res_det/mode3', file[:-4] + '_origin' + '.jpg')
                ...
                #plot_img.save(os.path.join('/home/chen-ubuntu/Desktop/checks_dataset/res_det/mode3', file[:-4] + '_detected' + '.jpg'))
                orig_vertices = []
                theta = 0
                for box in boxes:
                    box = np.array(box[:8])
                ...
                #img_savepath = os.path.join('/home/chen-ubuntu/Desktop/checks_dataset/res_det/mode3', file[:-4] + '_rotated' + '.jpg')
                ...
                for i, item in enumerate(shape):
                    ...
                    img_savepath = os.path.join('/home/chen-ubuntu/Desktop/checks_dataset/res_det/exp_mode3', img_newname)
