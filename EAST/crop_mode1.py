...
if __name__ == '__main__':
    ...
    model_path = '/home/chen-ubuntu/Desktop/checks_dataset/pths/model_mode1_epoch_24.pth'
    ...
    trainImgPath = '/home/chen-ubuntu/Desktop/checks_dataset/test_rotated_mode1/Image'
    #create_label = '/home/chen-ubuntu/Desktop/checks_dataset/res_det/res_det_mode1.txt'
    #trainLabelPath = '/Volumes/朱振洋/rotated_mode1/Label'
        ...
        for root, dirs, files in os.walk(trainImgPath):#trainLabelPath):
            for file in sorted(files):
                ...
                for i, item in enumerate(shape):
                    ...
                    img_savepath = os.path.join('/home/chen-ubuntu/Desktop/checks_dataset/res_det/exp_mode1', img_newname)
